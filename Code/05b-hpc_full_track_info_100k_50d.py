...
with open('TrackID_Lookup.txt', 'rb') as f:
    tab = pickle.load(f)
...
with open('TrackID_Artist_Lookup.txt', 'rb') as f:
    tab = pickle.load(f)
...
with open('TrackID_Album_Lookup.txt', 'rb') as f:
    tab = pickle.load(f)
...
with open('Lookup_Vocab100k_50d.txt', 'wb') as f:
    pickle.dump(vocab, f)